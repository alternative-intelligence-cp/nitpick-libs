...
| s1 | `nitpick-regex` | 0.0.3 — the harness, part 2 | *(NOT dispatched — paused at the author's request)* | — | — | **0.0.2 DONE and VERIFIED PASS** at `e35ba16`, pushed, CI green. 0.0.3 is planned, unblocked and amended in place by 0.0.2 (§3's case list seven → eleven, §4's `check_no_syscalls` row rewritten against RX-116/RX-120, §5's acceptance). **It is the next dispatch when work resumes** |
