...
| **The 2026-09-25 defects, O-N20 … O-N28** | every library at the re-pin | **~~O-N20~~ ~~O-N21~~ ~~O-N22~~ ~~O-N23~~ ~~O-N24~~ ~~O-N26~~ DISCHARGED at the pin `c970483`** — each reproduced here at both pins 2026-09-26 ~06:4x, the defect at `c3bdae2` and the refusal (or the right answer, O-N23) at `c970483`, controls unchanged. **O-N25** (DEF-107, the view freeze `BORROW-015`) and **O-N28** (DEF-116, `TYPE-014` on a trait's `move`) are fixed on the compiler's `main` and wait for the next re-pin. **O-N27** (S-107) is the author's decision |
